...
export const copilotResponseSchema = z.discriminatedUnion("type", [
    responseBase.extend({ type: z.literal("text"), message: z.string(), bullets: z.array(z.string()).optional(), sections: z.array(z.object({ heading: z.string(), body: z.string().optional(), bullets: z.array(z.string()).optional(), kind: z.enum(["normal", "example", "warning", "recommendation"]).default("normal") })).optional(), recommendation: z.string().optional() }),
