...
export function SlideElement({ element, editing = false, onTextChange }: { element: PptElement; editing?: boolean; onTextChange?: (value: string) => void }) {
  ...
  if (element.type === "image") return <div style={{ ...frame, background: "linear-gradient(135deg,#ccfbf1,#bae6fd)", borderRadius: 14, display: "flex", alignItems: "center", justifyContent: "center", color: "#0f766e", fontWeight: 700 }}>{element.content || "Visual"}</div>;
