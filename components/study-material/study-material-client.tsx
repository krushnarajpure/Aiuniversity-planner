        ...
        <div className="p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-200 font-medium hover:opacity-90 transition whitespace-nowrap"
                >
                    <Plus className="w-4 h-4" />
                    Quick Note
                </button>
